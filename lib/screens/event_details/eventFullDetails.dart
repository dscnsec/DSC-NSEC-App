...
class eventFullDetails extends StatefulWidget{
  ...
  eventFullDetails(this.card_index);

  @override
  State<StatefulWidget> createState() {
    return eventFullDetailsState(this.card_index);
...
class eventFullDetailsState extends State<eventFullDetails>{
  ...
  eventFullDetailsState(this.card_index);
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "Welcome to Individual Event Full Details Section\n\nEvent Number-$card_index",
  ...
  Future<bool> _onBackPressed() {
    return showDialog(
        ...
        builder: (context) => AlertDialog(
          title: Text("Return to Events Page!",style: TextStyle(fontFamily: "productSans"),),
          actions: [
            FlatButton.icon(
