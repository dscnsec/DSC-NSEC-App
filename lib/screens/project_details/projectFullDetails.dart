...
class projectFullDetails extends StatefulWidget {
  ...
  @override
  projectFullDetailsState createState() => projectFullDetailsState(this.card_index);
}
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Welcome to Project FULL Detals Section\n\nCARD-index=$card_index",style: TextStyle(fontSize: 25,fontFamily: 'Google-Sans'),) ,
