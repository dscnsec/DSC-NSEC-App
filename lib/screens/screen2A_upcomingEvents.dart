...
class screen2A_upcomingEvents extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return screen2A_upcomingEventsState();
  }
}

class screen2A_upcomingEventsState extends State<screen2A_upcomingEvents> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Welcome to Upcoming Events Section",style: TextStyle(fontSize: 25,fontFamily: 'Google-Sans'),) ,
