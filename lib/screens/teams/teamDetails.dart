...
Future<Album> fetchAlbum() async {
  final response = await http
      .get('https://www.attendanceapp.ml/dsc_testing/${teamCategoryFinal}.json');
...
class teamDetailsState extends State<teamDetails>
  ...
  Widget build(BuildContext context) {
    ...
    return
      ...
      return Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Oops! Unable to fetch info. Check your network or Try Again.",
              textAlign: TextAlign.center,
              style: TextStyle(
                fontFamily: 'productSans',
                fontSize: 16.0,
          ...
          Padding(
            ...
            child: RaisedButton.icon(
              ...
              }, icon: Icon(Icons.refresh, color: Colors.white,), label:Text("Refresh",
              textAlign: TextAlign.center,
              style: TextStyle(
                fontFamily: 'productSans',
                fontSize: 16.0,
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Center(child: CircularProgressIndicator(backgroundColor: teamColor, valueColor: new AlwaysStoppedAnimation<Color>(Colors.white),)),
      ],
    );
    }),
            Column(
